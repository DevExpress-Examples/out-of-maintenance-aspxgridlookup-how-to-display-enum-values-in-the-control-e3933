...
Partial Public Class _Default
	...
	Protected Sub gridLookup_Init(ByVal sender As Object, ByVal e As EventArgs)
		...
		gl.DataSource = CreateIEnumerableDataSourceFromEnum(GetType(CustomEnum))
		gl.DataBind()
	End Sub

    Private Function CreateIEnumerableDataSourceFromEnum(ByVal enumType As Type) As IEnumerable(Of Object)
        'C# Only
